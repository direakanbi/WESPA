    ...
    <footer className="border-t border-border bg-black text-white mt-20">
      <div className="container-width py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/committee" className="text-white/80 hover:text-primary transition-colors">
                  Committee
                </Link>
              </li>
              <li>
                <Link href="/rankings" className="text-white/80 hover:text-primary transition-colors">
                  Rankings
                </Link>
              </li>
              <li>
                <Link href="/tournaments" className="text-white/80 hover:text-primary transition-colors">
                  Tournaments
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/youth" className="text-white/80 hover:text-primary transition-colors">
                  Youth Program
                </Link>
              </li>
              <li>
                <Link href="/membership" className="text-white/80 hover:text-primary transition-colors">
                  Membership
                </Link>
              </li>
              <li>
                <Link href="/donate" className="text-white/80 hover:text-primary transition-colors">
                  Friends of WESPA
                </Link>
              </li>
              <li>
                <Link href="/associations" className="text-white/80 hover:text-primary transition-colors">
                  Global Associations
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="mt-4">
              <Link href="/contact" className="text-sm text-primary hover:text-secondary transition-colors font-medium">
                Contact Form →
              </Link>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border text-center text-sm text-white/80">
          <p>&copy; {new Date().getFullYear()} WESPA. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
