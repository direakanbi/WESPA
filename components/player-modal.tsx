        ...
        <div className="flex-1 overflow-y-auto space-y-6 pb-6">
          <div className="flex items-center space-x-4 px-6 pt-4">
            <Avatar className="h-20 w-20">
              <AvatarImage src={player.profileImage} alt={player.player_name} />
            ...
            <div>
              ...
              <p className="text-lg font-medium text-muted-foreground">
                Matches Played: {player.total_games}
              </p>
              <p className="text-lg font-medium text-muted-foreground">
                Last Played: {player.last_played}
              </p>
            ...
            <div className="px-6">
              ...
              <div className="space-y-3">
                {player.recentGames.map((game, index) => (
                  <div
                    key={index}
                    className="flex justify-between items-center bg-muted/30 p-3 rounded-lg border border-border text-muted-foreground shadow-sm"
                  >
                    <span className="font-medium">vs. {game.opponent}</span>
                    <div className="flex items-center gap-2">
                      <Badge
                        variant={
                          game.result === 'Win' ? 'primary' : 'destructive'
                        }
                      >
                        {game.result}
                      </Badge>
